...
import ReEditable from './ReEditable';
import './Recharge.css'
      ...
      <form onSubmit={handleEditFormSubmit}>
        <table className='user-table'>
          ...
          <tbody>
            {users.map((userlist) => (
              <Fragment>
                {edituserId === userlist._id ? (<ReEditable key={userlist._id} editFormData={editFormData} handleEditFormChange={handleEditFormChange} handleCancleClick={handleCancleClick} />
                ) : (
                  <RechargeRow key={userlist._id} userlist={userlist} handleEditClick={handleEditClick} handleDeleteClick={handleDeleteClick} />)}
              </Fragment>
            ))}
