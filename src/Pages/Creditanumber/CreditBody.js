  ...
  return (
    ...
    <div className='shadow-md p-5'>
        <div className='flex justify-between items-center mb-4'>
            ...
            <input className='px-2 rounded lg:w-46 w-36 py-2 hover:outline-none focus:outline-none focus:ring-1 focus:ring-[#5bc0de] border-2 border-[#5bc0de]' type="text" placeholder='Search Number' />
        </div>
        <hr />
        <div className='lg:flex justify-between mt-5'>
            ...
            <div className='lg:flex justify-between mt-5 bg-base-300 px-3 font-semibold py-1'>
